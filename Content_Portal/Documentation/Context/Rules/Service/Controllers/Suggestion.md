...
<h1 id="context-rules-service-controllers-suggestion-suggestion">Suggestion</h1>
...
`string token`<br/>A Guid which corresponds to a SuggestionResponse that has been created using the CancellationToken) method.<br/><br/>`undefined tenantId`<br/>undefined<br/><br/>`undefined namespaceId`<br/>undefined<br/><br/>
