...
```text 
GET /api/v1-preview/tenants/{tenantId}/namespaces/{namespaceId}/accesscontrol/clientfailover/groups
```
...
```text 
PUT /api/v1-preview/tenants/{tenantId}/namespaces/{namespaceId}/accesscontrol/clientfailover/groups
```
