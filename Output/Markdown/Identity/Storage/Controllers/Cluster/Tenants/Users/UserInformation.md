...
## Get User Information For Token Refresh2

<a id="opIdUserInformation_Get User Information For Token Refresh2"></a>
...
<h3 id="userinformation_get-user-information-for-token-refresh2-parameters">Parameters</h3>

`string tenantId`<br/>Id of Tenant.<br/><br/>`string userId`<br/>User Id.<br/><br/>`string claimTypes`<br/>Claim Types.<br/><br/>

<h3 id="userinformation_get-user-information-for-token-refresh2-responses">Responses</h3>
